# Purpose: Profile project: vertical data base with 7 visits
# Version: 2
# Date: 12/06/2021
# Author:  HPF
#
...
MWD1095A<-MWD
MWD1095A1<-data.frame(MWD1095A[1],MWD1095A[20:25])# select ppFVC visits from 1 to 7 and patients
...
ClM4<- MWDSoM417 %>% group_by(Cl4, visit_Idx) %>% dplyr:: summarise(n = n(),
                                                                    mean = mean(ppFVC),
                                                                    median = median(ppFVC),
...
write.csv(MWDSoM417, file="MDataSoMV_OptimModels_415oX11v_220621.csv", na="")
